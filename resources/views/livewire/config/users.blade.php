            ...
            <table class="min-w-full text-left bg-white">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-[13px] font-bold text-gray-700 tracking-wide">Nombre</th>
                        <th class="px-6 py-4 text-[13px] font-bold text-gray-700 tracking-wide">Correo</th>
                        <th class="px-6 py-4 text-[13px] font-bold text-gray-700 tracking-wide">Estatus</th>
                        <th class="px-6 py-4 text-[13px] font-bold text-gray-700 tracking-wide">Usuario</th>
                        <th class="px-6 py-4 text-[13px] font-bold text-gray-700 tracking-wide">Nombre de Rol</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        {{-- Data --}}
                        <td class="px-6 py-3 text-[13px] text-gray-800 whitespace-nowrap">{{ $user['nombre'] }}</td>
                        <td class="px-6 py-3 text-[13px] text-gray-600 whitespace-nowrap">{{ $user['correo'] }}</td>
                        <td class="px-6 py-3 text-[13px] text-gray-800 whitespace-nowrap">{{ $user['estatus'] }}</td>
                        <td class="px-6 py-3 text-[13px] text-gray-800 whitespace-nowrap">{{ $user['usuario'] }}</td>
                        <td class="px-6 py-3 text-[13px] text-gray-800 whitespace-nowrap">{{ $user['nombre_rol'] }}</td>
                    </tr>
                    @empty
                    <tr>
