...
<nav class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 z-30 select-none w-full">
    <!-- Left: Logo & Status -->
    <div class="flex items-center gap-4">
        <!-- Logo -->
        <a href="{{ route('dashboard') }}" wire:navigate class="text-2xl font-extrabold text-[#004066] tracking-wider">
            RUTX
        </a>

        <!-- Status Pill -->
        <div class="flex items-center gap-1.5 border border-gray-200 rounded-full px-3 py-1 bg-[#f9fafb]">
    ...
    <div class="flex items-center h-full gap-2">
        ...
        <!-- Ruta -->
        <a href="{{ route('ruta.rutas') }}" wire:navigate class="flex flex-col items-center justify-center h-full px-5 border-b-2 {{ request()->routeIs('ruta.*') ? 'border-[#004066] text-[#004066] font-semibold' : 'border-transparent text-gray-500 hover:text-[#004066] hover:border-gray-200' }} transition-all duration-150">
            <!-- Map Pin Icon -->
            <svg class="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <!-- Configuración -->
        <a href="{{ route('config.users') }}" class="flex flex-col items-center justify-center h-full px-5 border-b-2 {{ request()->routeIs('config.*') ? 'border-[#004066] text-[#004066] font-semibold' : 'border-transparent text-gray-500 hover:text-[#004066] hover:border-gray-200' }} transition-all duration-150">
            <!-- Cog Icon -->
            <svg class="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
