...
<div x-data="{ collapsed: false }" 
    ...
    <div class="flex flex-col overflow-y-auto">
        ...
        <nav class="flex-1 py-3 px-2 space-y-1">
            ...
            <!-- Cobranza -->
            <a href="{{ route('ventas.cobranza') }}" wire:navigate class="flex items-center gap-3 px-3 py-2 text-xs font-medium text-gray-300 hover:text-white hover:bg-[#002d48] rounded transition duration-150">
                <!-- Icon: Currency/Cash -->
                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
