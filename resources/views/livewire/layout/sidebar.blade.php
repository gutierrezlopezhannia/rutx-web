...
<div x-data="{ collapsed: false }" 
    ...
    <div class="flex flex-col overflow-y-auto">
        ...
        <nav class="flex-1 py-3 px-2 space-y-1">
            ...
            <!-- Cobranza -->
            <a href="{{ route('ventas.cobranza') }}" wire:navigate class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('ventas.cobranza') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                <!-- Icon: Currency/Cash -->
                <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('ventas.cobranza') ? 'text-orange-400' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <!-- Reportes y Gráficas -->
            <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('dashboard') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                <!-- Icon: Presentation Chart -->
                <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('dashboard') ? 'text-orange-400' : '' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
