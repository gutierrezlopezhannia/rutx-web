    ...
    <div class="flex flex-col overflow-y-auto">
        ...
        <nav class="flex-1 py-3 px-2 space-y-1">
            ...
            @elseif(request()->routeIs('ruta.*'))
                ...
                <a href="{{ route('ruta.agenda-entregas') }}" wire:navigate
                    class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('ruta.agenda-entregas') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                    <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('ruta.agenda-entregas') ? 'text-orange-400' : '' }}"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                    <span x-show="!collapsed" x-transition>Agenda de Entregas</span>
                </a>
                ...
                <a href="{{ route('ruta.log-sincronizacion') }}" wire:navigate
                    class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('ruta.log-sincronizacion') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                    <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('ruta.log-sincronizacion') ? 'text-orange-400' : '' }}"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>
                    <span x-show="!collapsed" x-transition>Clientes Sincronizados</span>
                </a>
            ...
            @elseif(request()->routeIs('productos.*'))
                ...
                <!-- Línea Familia -->
                <a href="{{ route('productos.linea-familia') }}" wire:navigate
                    class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('productos.linea-familia') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                    <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('productos.linea-familia') ? 'text-orange-400' : '' }}"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @else
                ...
                <a href="{{ route('ventas.nuevo-gasto-op') }}" wire:navigate
                    class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('ventas.nuevo-gasto-op') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                    <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('ventas.nuevo-gasto-op') ? 'text-orange-400' : '' }}"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="{{ route('ventas.preventa-entrega') }}" wire:navigate
                    class="flex items-center gap-3 px-3 py-2 text-xs rounded transition duration-150 {{ request()->routeIs('ventas.preventa-entrega') ? 'bg-[#004f7c] text-white border-l-4 border-orange-500 shadow-sm font-semibold' : 'font-medium text-gray-300 hover:text-white hover:bg-[#002d48]' }}">
                    <svg class="w-4 h-4 shrink-0 {{ request()->routeIs('ventas.preventa-entrega') ? 'text-orange-400' : '' }}"
                        fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
